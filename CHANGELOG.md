...
- Use [app-build-suite](https://github.com/giantswarm/app-build-suite) for metadata generation in `push-to-app-catalog` job.
...
[Unreleased]: https://github.com/giantswarm/architect-orb/compare/v0.17.0...HEAD
